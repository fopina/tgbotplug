# -*- coding: utf-8 -*-
"""
FOR THIS MODULE ALL CREDITS AND ORIGINAL LICENSE GO TO https://github.com/datamachine/twx.botapi/
Copied only to be able to maintain it easily for tgbotplug requirements
